...
${CRTTOOL}: FORCE
	${Q}${MAKE} PLAT=${PLAT} USE_TBBR_DEFS=${USE_TBBR_DEFS} COT=${COT} OPENSSL_DIR=${OPENSSL_DIR} CRTTOOL=${CRTTOOL} DEBUG=${DEBUG} V=${V} USE_AWS_KMS=${USE_AWS_KMS} AWS_KMS_PROVIDER_PATH=${AWS_KMS_PROVIDER_PATH} --no-print-directory -C ${CRTTOOLPATH} all
	@${ECHO_BLANK_LINE}
