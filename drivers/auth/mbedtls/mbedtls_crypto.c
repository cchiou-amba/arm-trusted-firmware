...
#define ED25519_DER_HEADER_LEN 12

char ed25519_asn1_object[] = {0x30, 0x05, 0x06, 0x03, 0x2b, 0x65, 0x70};
			    ...
			    void *pk_ptr, unsigned int pk_len)
{
	...
	if (memcmp(sig_alg, ed25519_asn1_object, sizeof(ed25519_asn1_object)) == 0) {
		unsigned char *ed25519_pubkey;
		unsigned char *ed25519_sig;

		if ((sig_len < 64U) ||
		    (pk_len < (ED25519_DER_HEADER_LEN + 32U))) {
			return CRYPTO_ERR_SIGNATURE;
		}

		ed25519_pubkey  = pk_ptr + ED25519_DER_HEADER_LEN;
		ed25519_sig = sig_ptr + (sig_len - 64);
		rc = ed25519_sha512_verify(data_ptr, data_len, ed25519_sig,
					   64U, ed25519_pubkey);
		if (rc != 0) {
			return rc;
		}
